...
- XLSX: hoja explícita si existe más de una; encabezados desplazados admitidos; se ignoran columnas no mapeadas. Las fórmulas y errores en celdas mapeadas se rechazan. No se usa un valor cacheado silenciosamente. Los números se recuperan del XML original y pasan directamente a Decimal, sin usar el float del lector; su token original queda en la procedencia. La notación científica del archivo se admite con límites de dígitos y exponente antes de expandirla. Esto conserva lo que contiene el archivo, sin reconstruir precisión que Excel ya hubiera perdido antes de guardarlo.
