...
- **First Pass Policy**: In accordance with Rule 11 of Phase 9:
  > *"Durante la PRIMERA PASADA de cada bloque no modificar src/freight_audit/ para conseguir resultados verdes. Un fallo de producto debe: preservarse, reducirse, clasificarse, medir blast radius ANTES de cualquier corrección de producción."*
